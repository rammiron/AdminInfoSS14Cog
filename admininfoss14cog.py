...
class AdminInfoSs14Cog(commands.Cog):
    ...
    @bot.slash_command(name="admins_list",
                       description=
    ...
    @bot.slash_command(name="user_bans_list",
    ...
    @bot.slash_command(name="user_job_bans_list")
    ...
    @bot.slash_command(name="top_bans_admin", description="Отображает топ админов по банам.")
    ...
    @bot.slash_command(name="top_job_bans_admin", description="Отображает топ админов по банам ролей.")
